<div class="ingredientsRecipes index">
	...
	<tr>
		...
		<td><?php echo h($ingredientsRecipe['IngredientsRecipe']['ingredient_id']); ?>&nbsp;</td>
		<td><?php echo h($ingredientsRecipe['IngredientsRecipe']['recipe_id']); ?>&nbsp;</td>
		<td><?php echo h($ingredientsRecipe['IngredientsRecipe']['created']); ?>&nbsp;</td>
		<td><?php echo h($ingredientsRecipe['IngredientsRecipe']['modified']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $ingredientsRecipe['IngredientsRecipe']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $ingredientsRecipe['IngredientsRecipe']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
