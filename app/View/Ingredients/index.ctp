<div class="ingredients index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $ingredient['Ingredient']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $ingredient['Ingredient']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
